...
sql = """select count(1) from tblappaudittrail
where  createdate >= sysdate - (interval '5' minute) and serviceuserid in (33)"""
  
total_value =  get_data(sql)

sql ="""select count(1) from tblappaudittrail
where  createdate >= sysdate - (interval '5' minute) and serviceuserid in (33) and statuscode = 200"""
...
sql = """select sum(rtt)/300 from tblappaudittrail
where  createdate >= sysdate - (interval '5' minute) and serviceuserid in (33)"""
